...
<nav class="navbar navbar-expand-lg fixed-top" style="background-color: rgb(255,255,255); border-bottom: 2px solid #2E7D32;">
        <div class="container-fluid">
            ...
            <?php if(isset($_SESSION['PrenomInput'])): ?>
                <span class="navbar-welcome" style="margin-left:24px; font-size:20px; color:#2E7D32; font-weight:bold;">Bienvenue, <?php echo htmlspecialchars($_SESSION['PrenomInput']); ?></span>
            <?php endif; ?>
...
<?php
if (isset($erreur)) echo '<div class="alert alert-danger">',$erreur,'</div>';
?>

<br>

<!-- on insère un lien qui nous permettra de retourner à l'accueil du forum -->
<a href="/Blog" class="btn btn-primary">Retour à l'accueil</a>
<br><br>
