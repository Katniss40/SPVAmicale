...
<section >
    ...
    <div class="container">
        <br>
        <h3> Modification uniquement adresse et/ou numéro de téléphone</h3>
        <br>
        <form>
            <div class="mb-3">
                <label for="NomInput" class="form-label">Nom*</label>
                <input type="text" class="form-control" id="NomInput" placeholder="Votre nom" value="John" name="Nom"> 
            </div>
            <div class="mb-3">
                <label for="PrenomInput" class="form-label">Prénom*</label>
                <input type="text" class="form-control" id="PrenomInput" placeholder="Votre prénom" value="Doe" name="Prenom"> 
            </div>
            <div class="mb-3">
              <label for="Adresse" class="form-label">Adresse</label>
              <input type="text" class="form-control" id="Adresse" placeholder="Adresse"  value="Adresse - Code Postal - Ville " name="Adresse">  
            </div>
            <div class="mb-3">
                <label for="Telephone" class="form-label">Téléphone</label>
                <input type="number" class="form-control" id="Telephone" placeholder="01.02.03.04.05"  value="Telephone" name="Telephone"> 
              </div>
              <a> * non modifiable.</a>
